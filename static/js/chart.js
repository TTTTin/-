function goChart(dataArr) {
    ...
    function initChart(){
        ...
        // posY = cMargin;   //
        posX = cMargin*8;
        posY = oy + radius + cMargin *3;
        textX = posX + tWidth + 15;
        textY = posY + tHeight - 2;
    ...
    function drawMarkers(){
        ...
        for (var i = 0; i < dataArr.length; i++){
            ...
            ctx.fillRect(posX + 300*i, posY, tWidth,  tHeight);
            ctx.moveTo(posX + 300*i, posY);
            ...
            ctx.fillText(percent, textX + 300*i, textY);
        }
    };
